...
public class FnViewVO implements Serializable {
    ...
    private List<FnItemVO>          contractTable;
    ...
    public List<FnItemVO> getContractTable() {
        return contractTable;
    }

    public void setContractTable(List<FnItemVO> contractTable) {
