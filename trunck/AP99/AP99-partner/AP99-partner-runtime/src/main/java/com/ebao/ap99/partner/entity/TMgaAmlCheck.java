 ...
 */
@Entity
@Table(name="T_RI_BP_MGA_AML_CHECK")
@NamedQuery(name="TMgaAmlCheck.findAll", query="SELECT t FROM TMgaAmlCheck t")
public class TMgaAmlCheck extends BaseEntityImpl implements Serializable {
