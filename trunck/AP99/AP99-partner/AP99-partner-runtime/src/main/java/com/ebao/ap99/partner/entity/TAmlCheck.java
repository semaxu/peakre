 ...
 */
@Entity
@Table(name="T_RI_BP_AML_CHECK")
@NamedQuery(name="TAmlCheck.findAll", query="SELECT t FROM TAmlCheck t")
public class TAmlCheck extends BaseEntityImpl implements Serializable {
