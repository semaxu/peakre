...
/**
 * The persistent class for the T_RI_CONT_SECTION_INFO_LOG database table.
 * 
 */
@Entity
@Table(name = "T_RI_CONT_SECTION_INFO_LOG")
@NamedQuery(name = "TRiContSectionInfoLog.findAll", query = "SELECT t FROM TRiContSectionInfoLog t")
public class TRiContSectionInfoLog extends BaseEntityImpl implements Serializable {
