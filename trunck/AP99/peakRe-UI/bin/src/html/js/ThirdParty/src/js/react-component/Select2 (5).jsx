...
(function (context, $, $pt) {
	var NSelect = React.createClass($pt.defineCellComponent({
		...
		componentDidUpdate: function (prevProps, prevState) {
			// react will not clear the options when js updating,
			...
			// reset the value when js update
		...
		/**
		 * remove tooltip, which is default set by select2 js.
		 * it's unnecessary.
		 */
		...
		resetOptions: function (newOptions) {
			...
			var orgValue = this.getValueFromModel(); //js.val();
