...
(function (context, $, $pt) {
    ...
    var ContractIDSearch = React.createClass($pt.defineCellComponent({
        statics: {
            SEARCH_URL: $ri.getRestfulURL("action.common.codeTable") + "/search?code=",
            ADVANCED_SEARCH_URL: $ri.getRestfulURL("action.common.codeTable") + "/page?code="
        },
        propTypes: {
            // model
        ...
        createNSearchLayout: function () {
                        ...
                        comp: {
                            ...
                            rowOperations: {
                                ...
                                click: function (row) {
                                    ...
                                    _this.getModel().set(_this.getDataId(), row.Name);
                                    _this.getModel().set("condition_UwYear", row.Code);
                                    //_this.getModel().mergeCurrentModel(dataModel);
                               //    _this.setLabelText(row.Code);
            ...
            return $pt.createCellLayout(this.getDataId(), {
                comp: {
                    ...
                    searchUrl: ContractIDSearch.SEARCH_URL + this.getComponentOption('codeName'),
                    advancedUrl: ContractIDSearch.ADVANCED_SEARCH_URL + this.getComponentOption('codeName'),
    ...
    context.ContractIDSearch = ContractIDSearch;
    NFormCell.registerComponentRenderer('ContractIDSearch', function (model, layout, direction, view) {
        return <ContractIDSearch model={model} layout={layout} view={view}/>;
    });
    $pt.ComponentConstants.ContractIDSearch = 'ContractIDSearch';
