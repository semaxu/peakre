                            ...
                            comp: {
                                ...
                                editLayout: function(model){
                                    model.addPostChangeListener("Amount", function(evt){
                                        ...
                                        if (amount == 0){
                                            NConfirm.getConfirmModal().show({
                                                title:"",
                                                disableClose: true,
                                                messages: ["Amount in Collection Currency must not be 0"]
                                            });
                                    ...
                                    return {
                                        ...
                                        AmountAssigned: {
                                            label: "Converted Amount in Collection Currency",
                                            base : $helper.baseAmount(2),
                                            comp: {
                                                enabled: false
                                            }
                                        ...
                                        CollectedAssignedDiff: {
                                            label: "Difference between Amount Collected and Assigned",
                                            base : $helper.baseAmount(2),
                                            comp: {
                                                enabled: false
                                            }
