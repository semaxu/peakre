            ...
            return {
                comp: {
                            ...
                            _this.state.calculator[rowId] = setTimeout(function() {
                                ...
                                if (amount == undefined || amount == "" || amount == 0 || amount == "0") {
                                    ...
                                    NConfirm.getConfirmModal().show({
                                        title:"",
                                        disableClose: true,
                                        messages: ['Amount in Payment Currency is required']
                                    });
                                    return;
                                }
                                ...
                                if (markOffAmount == undefined || markOffAmount == "" || isNaN(markOffAmount)) {
                                    evt.model.set("MarkOffAmount", "0.00");
                                    ...
                                    if (!isNaN(parseFloat(oldMarkOffAmount1))){
                                        var newTotalAmountAssigned1 = parseFloat(parseFloat(_this.getModel().get("AmountAssigned")).toFixed(2)) -
                                            parseFloat(parseFloat(oldMarkOffAmount1).toFixed(2));console.info(newTotalAmountAssigned1);
                                ...
                                if (parseFloat(markOffAmount) == 0){
                                    ...
                                    if (!isNaN(parseFloat(oldMarkOffAmount))){
                                        var newTotalAmountAssigned = parseFloat(parseFloat(_this.getModel().get("AmountAssigned")).toFixed(2)) -
                                            parseFloat(parseFloat(oldMarkOffAmount).toFixed(2));console.info(newTotalAmountAssigned);
                                        ...
                                        if (entryItems[j1].ParentFeeIdStr == parentFeeIdStr2 && entryItems[j1].FeeId != parentFeeIdStr2){
                                            ...
                                            if (undefined != markOffAmount && !isNaN(markOffAmount) && null != markOffAmount && "" != markOffAmount){
                                                ...
                                                if (parseFloat(settleDiff) == 0){
                                                    ...
                                                    settleDiff = $helper.formatNumberForLabel(settleDiff, 2);
                                                }
                    ...
                    columns: [
                        ...
                        {title: "Payment Amount", data: "SettleAmount",width: 140,inline:"inlineAmount"},
                        {title: "Payment Currency", data: "SettleCurrency",inline:"readonlyText",width: 80},
                        {title: "Exchange Rate", data: "ExchangeRate",width: 140,inline:"inlineExchangeRate"},
                        {title: "Fully Settle", data: "FullySettle",inline:"fullySettle",width: 60},
                        {title:"Settlement Difference(OC)",data:"SettleDiff",width: 140,inline:"inlineAmount"},
                        {title:"E/X Gain or Loss(USD)",data:"GainLoss",width: 140,inline:"inlineAmount"}
                    ]
                },
                css: {
                    comp: 'inline-editor'
