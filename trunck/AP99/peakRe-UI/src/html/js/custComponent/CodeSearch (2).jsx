/**
 * Created by xiaoyu.yang on 1/14/2016.
 */
(function (context, $, $pt) {
    ...
    var CodeSearch = React.createClass($pt.defineCellComponent({
        statics: {
        ...
        createNSearchLayout: function () {
                        ...
                        comp: {
                            ...
                            rowOperations: {
                                ...
                                click: function (row) {
                                    ...
                                    _this.getModel().set(_this.getDataId(), row.Code);
            ...
            return $pt.createCellLayout(this.getDataId(), {
                comp: {
                    ...
                    searchUrl: CodeSearch.SEARCH_URL,
                    advancedUrl: CodeSearch.ADVANCED_SEARCH_URL,
    ...
    context.CodeSearch = CodeSearch;
    NFormCell.registerComponentRenderer('codeSearch', function (model, layout, direction, view) {
        return <CodeSearch model={model} layout={layout} view={view}/>;
    });
    $pt.ComponentConstants.CodeSearch = 'codeSearch';
