...
/***/ function(module, exports, __webpack_require__) {
	...
	var PanelGroup = _react2['default'].createClass({
	  ...
	  shouldComponentUpdate: function shouldComponentUpdate() {
	    // Defer any updates to this js during the `onSelect` handler.
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * so an invalid js would not increase the index.
	 *
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DropdownButton = _react2['default'].createClass({
	  ...
	  renderMenuItem: function renderMenuItem(child, index) {
	    ...
	    // js or it's child, this allows a user not to pass an onSelect
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DropdownStateMixin = {
	  ...
	  handleDocumentClick: function handleDocumentClick(e) {
	    // If the click originated from within this js
	    // don't do anything.
...
/***/ function(module, exports, __webpack_require__) {
	...
	// https://www.npmjs.org/package/react-interpolate-js
	    ...
	    if (unsafe) {
	      var content = format.split(REGEXP).reduce(function (memo, match, index) {
	        ...
	        if (_react2['default'].isValidElement(html)) {
	          throw new Error('cannot interpolate a React js into unsafe text');
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ModalMarkup = _react2['default'].createClass({
	  ...
	  propTypes: {
	     ...
	     * @deprecated Use the "Modal.Header" js instead
	     */
	    title: _react2['default'].PropTypes.node,
	    /**
	     * Include a backdrop js. Specify 'static' for a backdrop that doesn't trigger an "onHide" when clicked.
	     */
	...
	var OverlayMixin = {
	  ...
	  _renderOverlay: function _renderOverlay() {
	    ...
	    if (overlay !== null) {
	      ...
	      // Unrender if the js is null for transitions to null
	      this._unrenderOverlay();
	  ...
	  getOverlayDOMNode: function getOverlayDOMNode() {
	    if (!this.isMounted()) {
	      throw new Error('getOverlayDOMNode(): A js must be mounted to have a DOM node.');
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	ModalHeader.propTypes = {
	  ...
	  closeButton: _react2['default'].PropTypes.bool,
	  /**
	   * A Callback fired when the close button is clicked. If used directly inside a Modal js, the onHide will automatically
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DepreciatedModalTrigger = _react2['default'].createClass({
	  ...
	  componentWillMount: function componentWillMount() {
	    (0, _utilsDeprecationWarning2['default'])('The `ModalTrigger` js', 'the `Modal` js directly', 'http://react-bootstrap.github.io/components.html#modals');
	  },
	...
	var OverlayTrigger = _react2['default'].createClass({
	  ...
	  render: function render() {
	    ...
	    if (this.props.trigger !== 'manual') {
	      ...
	      (0, _utilsDeprecationWarning2['default'])('"manual" trigger type', ' the Overlay js');
	    }
	...
	var RootCloseWrapper = (function (_React$Component) {
	  ...
	  _createClass(RootCloseWrapper, [{
	    ...
	    value: function handleDocumentClick(e) {
	      // If the click originated from within this js, don't do anything.
	      // e.srcElement is required for IE8 as e.target is undefined
	      var target = e.target || e.srcElement;
